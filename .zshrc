...
#if [ -f '/home/che/google-cloud-sdk/completion.zsh.inc' ]; then source '/home/che/google-cloud-sdk/completion.zsh.inc'; fi
#TIMEFMT='%J   %U  user %S system %P cpu %*E total'$'\n avg shared (code):         %X KB'$'\n avg unshared (data/stack): %D KB'$'\ntotal (sum):               %K KB'$'\n'\ 'max memory:                %M MB'$'\n page faults from disk:     %F'$'\n other page faults:         %R'
#SIEGE_HOME=/usr/local

alias echo2='cowsay -f $(ls /usr/share/cowsay/cows|shuf -n1)'
